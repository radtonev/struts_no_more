...
public class MerchantSiteWorkflow implements IWorkflow {
    ...
    private final Path file = Path.of("persistence/src/main/java/com/safecharge/ppp/persistence/dto/entities/MerchantSite.java");
    private final List<WorkflowClass> workflowClasses = List.of(new WorkflowClass(file, ClassRole.ENTITY),
            new WorkflowClass(Path.of("persistence/src/main/java/com/safecharge/ppp/persistence/dto/output/MerchantSiteDTO.java"),
                    ClassRole.DTO),
